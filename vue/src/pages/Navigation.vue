  ...
  <div class="flex flex-col justify-center items-center h-max pt-[80px]">
    ...
    <div class="flex flex-col gap-8">
      <router-link :to="{ name: 'pos' }">
        <PrimaryButton text="POS System" :height="84" :width="723" />
      </router-link>
      <router-link :to="{ name: 'dashboard' }"
        ><PrimaryButton text="Dashboard" :height="84" :width="723"
      /></router-link>
      <router-link :to="{ name: 'account-creation' }">
        ...
        <SecondaryButton @click="logout" text="Log Out" :height="84" :width="723" />
