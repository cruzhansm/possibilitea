            ...
            <div class="flex flex-row justify-even items-start ml-[150px] mt-8">
                <div class="flex flex-col space-y-2">
                    <div
                        src=""
                        alt=""
                        class="w-[411px] h-[381px] bg-secondary rounded-[9px] m-2 mr-12"
                    ></div>
                    <button
                        class="bg-primary w-[174px] h-[47px] text-buttonText text-textButtons rounded-[9px] ml-2 hover:bg-primaryHovered"
                    >
                        UPLOAD
                    </button>
                </div>
